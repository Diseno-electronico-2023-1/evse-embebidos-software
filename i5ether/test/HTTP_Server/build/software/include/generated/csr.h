//--------------------------------------------------------------------------------
// Auto-generated by LiteX (782f045b) on 2023-05-15 00:37:05
//--------------------------------------------------------------------------------
...
/* spi1 */
#define CSR_SPI1_BASE (CSR_BASE + 0x0L)
#define CSR_SPI1_CONTROL_ADDR (CSR_BASE + 0x0L)
#define CSR_SPI1_CONTROL_SIZE 1
static inline uint32_t spi1_control_read(void) {
	return csr_read_simple((CSR_BASE + 0x0L));
}
static inline void spi1_control_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x0L));
}
#define CSR_SPI1_CONTROL_START_OFFSET 0
#define CSR_SPI1_CONTROL_START_SIZE 1
static inline uint32_t spi1_control_start_extract(uint32_t oldword) {
	uint32_t mask = 0x1;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t spi1_control_start_read(void) {
	uint32_t word = spi1_control_read();
	return spi1_control_start_extract(word);
}
static inline uint32_t spi1_control_start_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = 0x1;
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void spi1_control_start_write(uint32_t plain_value) {
	uint32_t oldword = spi1_control_read();
	uint32_t newword = spi1_control_start_replace(oldword, plain_value);
	spi1_control_write(newword);
}
#define CSR_SPI1_CONTROL_LENGTH_OFFSET 8
#define CSR_SPI1_CONTROL_LENGTH_SIZE 8
static inline uint32_t spi1_control_length_extract(uint32_t oldword) {
	uint32_t mask = 0xff;
	return ( (oldword >> 8) & mask );
}
static inline uint32_t spi1_control_length_read(void) {
	uint32_t word = spi1_control_read();
	return spi1_control_length_extract(word);
}
static inline uint32_t spi1_control_length_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = 0xff;
	return (oldword & (~(mask << 8))) | (mask & plain_value)<< 8 ;
}
static inline void spi1_control_length_write(uint32_t plain_value) {
	uint32_t oldword = spi1_control_read();
	uint32_t newword = spi1_control_length_replace(oldword, plain_value);
	spi1_control_write(newword);
}
#define CSR_SPI1_STATUS_ADDR (CSR_BASE + 0x4L)
#define CSR_SPI1_STATUS_SIZE 1
static inline uint32_t spi1_status_read(void) {
	return csr_read_simple((CSR_BASE + 0x4L));
}
#define CSR_SPI1_STATUS_DONE_OFFSET 0
#define CSR_SPI1_STATUS_DONE_SIZE 1
static inline uint32_t spi1_status_done_extract(uint32_t oldword) {
	uint32_t mask = 0x1;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t spi1_status_done_read(void) {
	uint32_t word = spi1_status_read();
	return spi1_status_done_extract(word);
}
#define CSR_SPI1_STATUS_MODE_OFFSET 1
#define CSR_SPI1_STATUS_MODE_SIZE 1
static inline uint32_t spi1_status_mode_extract(uint32_t oldword) {
	uint32_t mask = 0x1;
	return ( (oldword >> 1) & mask );
}
static inline uint32_t spi1_status_mode_read(void) {
	uint32_t word = spi1_status_read();
	return spi1_status_mode_extract(word);
}
#define CSR_SPI1_MOSI_ADDR (CSR_BASE + 0x8L)
#define CSR_SPI1_MOSI_SIZE 1
static inline uint32_t spi1_mosi_read(void) {
	return csr_read_simple((CSR_BASE + 0x8L));
}
static inline void spi1_mosi_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x8L));
}
#define CSR_SPI1_MISO_ADDR (CSR_BASE + 0xcL)
#define CSR_SPI1_MISO_SIZE 1
static inline uint32_t spi1_miso_read(void) {
	return csr_read_simple((CSR_BASE + 0xcL));
}
#define CSR_SPI1_CS_ADDR (CSR_BASE + 0x10L)
#define CSR_SPI1_CS_SIZE 1
static inline uint32_t spi1_cs_read(void) {
	return csr_read_simple((CSR_BASE + 0x10L));
}
static inline void spi1_cs_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x10L));
}
#define CSR_SPI1_CS_SEL_OFFSET 0
#define CSR_SPI1_CS_SEL_SIZE 1
static inline uint32_t spi1_cs_sel_extract(uint32_t oldword) {
	uint32_t mask = 0x1;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t spi1_cs_sel_read(void) {
	uint32_t word = spi1_cs_read();
	return spi1_cs_sel_extract(word);
}
static inline uint32_t spi1_cs_sel_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = 0x1;
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void spi1_cs_sel_write(uint32_t plain_value) {
	uint32_t oldword = spi1_cs_read();
	uint32_t newword = spi1_cs_sel_replace(oldword, plain_value);
	spi1_cs_write(newword);
}
#define CSR_SPI1_CS_MODE_OFFSET 16
#define CSR_SPI1_CS_MODE_SIZE 1
static inline uint32_t spi1_cs_mode_extract(uint32_t oldword) {
	uint32_t mask = 0x1;
	return ( (oldword >> 16) & mask );
}
static inline uint32_t spi1_cs_mode_read(void) {
	uint32_t word = spi1_cs_read();
	return spi1_cs_mode_extract(word);
}
static inline uint32_t spi1_cs_mode_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = 0x1;
	return (oldword & (~(mask << 16))) | (mask & plain_value)<< 16 ;
}
static inline void spi1_cs_mode_write(uint32_t plain_value) {
	uint32_t oldword = spi1_cs_read();
	uint32_t newword = spi1_cs_mode_replace(oldword, plain_value);
	spi1_cs_write(newword);
}
#define CSR_SPI1_LOOPBACK_ADDR (CSR_BASE + 0x14L)
#define CSR_SPI1_LOOPBACK_SIZE 1
static inline uint32_t spi1_loopback_read(void) {
	return csr_read_simple((CSR_BASE + 0x14L));
}
static inline void spi1_loopback_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x14L));
}
#define CSR_SPI1_LOOPBACK_MODE_OFFSET 0
#define CSR_SPI1_LOOPBACK_MODE_SIZE 1
static inline uint32_t spi1_loopback_mode_extract(uint32_t oldword) {
	uint32_t mask = 0x1;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t spi1_loopback_mode_read(void) {
	uint32_t word = spi1_loopback_read();
	return spi1_loopback_mode_extract(word);
}
static inline uint32_t spi1_loopback_mode_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = 0x1;
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void spi1_loopback_mode_write(uint32_t plain_value) {
	uint32_t oldword = spi1_loopback_read();
	uint32_t newword = spi1_loopback_mode_replace(oldword, plain_value);
	spi1_loopback_write(newword);
}
#define CSR_SPI1_CLK_DIVIDER_ADDR (CSR_BASE + 0x18L)
#define CSR_SPI1_CLK_DIVIDER_SIZE 1
static inline uint32_t spi1_clk_divider_read(void) {
	return csr_read_simple((CSR_BASE + 0x18L));
}
static inline void spi1_clk_divider_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x18L));
}

/* leds */
#define CSR_LEDS_BASE (CSR_BASE + 0x800L)
#define CSR_LEDS_OUT_ADDR (CSR_BASE + 0x800L)
...
/* ethmac */
#define CSR_ETHMAC_BASE (CSR_BASE + 0x1800L)
#define CSR_ETHMAC_SRAM_WRITER_SLOT_ADDR (CSR_BASE + 0x1800L)
#define CSR_ETHMAC_SRAM_WRITER_SLOT_SIZE 1
static inline uint32_t ethmac_sram_writer_slot_read(void) {
	return csr_read_simple((CSR_BASE + 0x1800L));
}
#define CSR_ETHMAC_SRAM_WRITER_LENGTH_ADDR (CSR_BASE + 0x1804L)
...
#define CSR_ETHMAC_SRAM_WRITER_ERRORS_ADDR (CSR_BASE + 0x1808L)
...
#define CSR_ETHMAC_SRAM_WRITER_EV_STATUS_ADDR (CSR_BASE + 0x180cL)
...
#define CSR_ETHMAC_SRAM_WRITER_EV_PENDING_ADDR (CSR_BASE + 0x1810L)
...
#define CSR_ETHMAC_SRAM_WRITER_EV_ENABLE_ADDR (CSR_BASE + 0x1814L)
...
#define CSR_ETHMAC_SRAM_READER_START_ADDR (CSR_BASE + 0x1818L)
...
#define CSR_ETHMAC_SRAM_READER_READY_ADDR (CSR_BASE + 0x181cL)
...
#define CSR_ETHMAC_SRAM_READER_LEVEL_ADDR (CSR_BASE + 0x1820L)
...
#define CSR_ETHMAC_SRAM_READER_SLOT_ADDR (CSR_BASE + 0x1824L)
...
#define CSR_ETHMAC_SRAM_READER_LENGTH_ADDR (CSR_BASE + 0x1828L)
...
#define CSR_ETHMAC_SRAM_READER_EV_STATUS_ADDR (CSR_BASE + 0x182cL)
...
#define CSR_ETHMAC_SRAM_READER_EV_PENDING_ADDR (CSR_BASE + 0x1830L)
...
#define CSR_ETHMAC_SRAM_READER_EV_ENABLE_ADDR (CSR_BASE + 0x1834L)
...
#define CSR_ETHMAC_PREAMBLE_CRC_ADDR (CSR_BASE + 0x1838L)
...
#define CSR_ETHMAC_RX_DATAPATH_PREAMBLE_ERRORS_ADDR (CSR_BASE + 0x183cL)
...
#define CSR_ETHMAC_RX_DATAPATH_CRC_ERRORS_ADDR (CSR_BASE + 0x1840L)
...
/* ethphy */
#define CSR_ETHPHY_BASE (CSR_BASE + 0x2000L)
#define CSR_ETHPHY_CRG_RESET_ADDR (CSR_BASE + 0x2000L)
...
#define CSR_ETHPHY_RX_INBAND_STATUS_ADDR (CSR_BASE + 0x2004L)
...
#define CSR_ETHPHY_MDIO_W_ADDR (CSR_BASE + 0x2008L)
...
#define CSR_ETHPHY_MDIO_R_ADDR (CSR_BASE + 0x200cL)
...
/* i2c0 */
#define CSR_I2C0_BASE (CSR_BASE + 0x2800L)
#define CSR_I2C0_W_ADDR (CSR_BASE + 0x2800L)
...
#define CSR_I2C0_R_ADDR (CSR_BASE + 0x2804L)
...
#define CSR_TIMER0_UPTIME_LATCH_ADDR (CSR_BASE + 0x4020L)
...
#define CSR_TIMER0_UPTIME_CYCLES_ADDR (CSR_BASE + 0x4024L)
