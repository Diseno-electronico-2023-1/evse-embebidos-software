...
{
    ui_S5 = lv_obj_create(NULL);
    lv_obj_clear_flag(ui_S5, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_Label3 = lv_label_create(ui_S5);
    ...
    ui_Label7 = lv_label_create(ui_S5);
    ...
    lv_obj_add_event_cb(ui_S5, ui_event_S5, LV_EVENT_ALL, NULL);
